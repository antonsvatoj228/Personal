...
def build(wb, data):
    ...
    label(ws,'H70','Логіка: RO-ціна задається лише для 4 опорних категорій, решта формуються множниками. '
                   'Крок округлення (G7) застосовується до базової ціни за 1–2 особи після знижки; крок за 3-го й наступних '
                   'гостей (G6) додається точно, помножений на знижку, і не округлюється. BB / BBSPA додають пакет за кожного гостя, '
